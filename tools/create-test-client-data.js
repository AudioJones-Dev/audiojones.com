...
// Retired auth. See docs/architecture/stack-decision.md. Replacement seeding
// against NeonDB will be added when the client portal data model is migrated.

console.error(
  "create-test-client-data is disabled: Retired auth has been removed from audiojones.com.\n" +
