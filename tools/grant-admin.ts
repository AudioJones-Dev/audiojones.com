...
//
// Retired auth has been removed from audiojones.com. This script previously
// stamped retired auth custom claims to elevate users; the equivalent operation
...
async function main() {
  ...
  console.error(
    `Cannot grant admin to ${email}: Retired auth has been removed from audiojones.com.\n` +
