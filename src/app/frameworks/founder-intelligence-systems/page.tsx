  ...
  return (
    <>
      ...
      <FrameworkArticle
        ...
        intro="Founder Intelligence System is not a tool category. It's a way of designing the business so that human judgment, data, and AI compound — instead of compete."
        definition={DEFINITION}
      >
        <H2>Founder Intelligence System vs AI automation</H2>
        <P>
        ...
        <H2>The seven-layer Founder Intelligence System stack</H2>
        <P>
