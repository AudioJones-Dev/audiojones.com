      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <button
            ...
            className="bg-gradient-to-r from-[#E8FF5A] to-[#F0FF85] hover:from-[#F0FF85] hover:to-[#F0FF85] text-black font-bold py-4 px-8 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
          >
            {primaryCta}
          </button>
