    ...
    <section className="relative bg-[#0B0B0B] py-16 sm:py-20 lg:py-24 text-white">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <p className="text-sm font-bold uppercase tracking-widest text-signal-yellow">CLIENT RESULTS</p>
          ...
          <p className="mt-6 max-w-2xl mx-auto text-lg leading-8 text-text-muted">
        ...
        <div className="mt-12 md:mt-16 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <article className="relative rounded-xl bg-white/5 p-8 shadow-lg ring-1 ring-white/10">
            <div className="absolute -top-px left-8 right-8 h-px bg-gradient-to-r from-transparent via-signal-yellow to-transparent" />
            <div className="flex items-center gap-6">
              <div className="h-16 w-16 flex-shrink-0 rounded-full bg-center bg-cover p-1 ring-2 ring-offset-2 ring-offset-[#0B0B0B] ring-signal-yellow">
                <Image
              ...
              <div>
                ...
                <p className="text-sm text-text-muted">Business Owner</p>
              </div>
            </div>
            <blockquote className="mt-6 text-base leading-7 text-text-muted">
          ...
          <article className="relative rounded-xl bg-white/5 p-8 shadow-lg ring-1 ring-white/10">
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-sm text-text-muted">Music Executive, Circle House Digital</p>
              </div>
            </div>
            <blockquote className="mt-6 text-base leading-7 text-text-muted">
          ...
          <article className="relative rounded-xl bg-white/5 p-8 shadow-lg ring-1 ring-white/10">
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-sm text-text-muted">99 Jams Radio Personality</p>
              </div>
            </div>
            <blockquote className="mt-6 text-base leading-7 text-text-muted">
        ...
        <div className="mt-16 flex justify-center">
          <a 
            href="/book" 
            className="inline-flex h-14 items-center justify-center rounded-full px-8 bg-signal-yellow hover:bg-signal-soft text-black text-base font-bold tracking-wide shadow-[0_0_20px_0_rgba(232,255,90,0.45)] hover:scale-105 transition"
          >
