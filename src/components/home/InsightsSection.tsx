        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <article className="flex flex-col bg-black/35 backdrop-blur-sm rounded-2xl border border-white/5 overflow-hidden">
            ...
            <div className="p-6 flex flex-col gap-3 flex-1">
              <p className="text-xs uppercase tracking-wide text-[#F0FF85]">AI Marketing • 5 min read</p>
          ...
          <article className="flex flex-col bg-black/35 backdrop-blur-sm rounded-2xl border border-white/5 overflow-hidden">
            ...
            />
            <div className="p-6 flex flex-col gap-3 flex-1">
              <p className="text-xs uppercase tracking-wide text-[#F0FF85]">Content Systems • 7 min read</p>
              <h3 className="text-lg font-semibold leading-snug">
          ...
          <article className="flex flex-col bg-black/35 backdrop-blur-sm rounded-2xl border border-white/5 overflow-hidden">
            ...
            />
            <div className="p-6 flex flex-col gap-3 flex-1">
              <p className="text-xs uppercase tracking-wide text-[#F0FF85]">AEO / Local SEO • 6 min read</p>
              <h3 className="text-lg font-semibold leading-snug">
