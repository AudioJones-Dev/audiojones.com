...
const CARD_CONFIG = {
  ...
  signal: {
    bg: "rgba(15,15,15,0.84)",
    border: "none",
    dotColor: "#E8FF5A",
    boxShadow:
      "0 0 32px -8px rgba(232,255,90,0.22), 0 0 14px -6px rgba(77,172,255,0.10), inset 0 0 0 1px rgba(232,255,90,0.08)",
    animated: true,
  },
} as const;
  ...
  return (
    ...
    >
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        {/* Amber glow — left, behind Noise card */}
        <div
          style={{
            position: "absolute",
            top: "20%",
            ...
            height: "70%",
            background:
              "radial-gradient(ellipse 80% 80% at 20% 55%, rgba(255,179,64,0.07), transparent 70%)",
          }}
        />
      ...
      <div className="mx-auto max-w-[1280px] px-5 sm:px-8">
                  ...
                  <>
                    ...
                    <div
                      ...
                      style={{
                        ...
                        inset: "-1px",
                        backgroundImage:
                          "linear-gradient(135deg, rgba(232,255,90,0.55), rgba(77,172,255,0.36) 55%, rgba(232,255,90,0.30))",
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          ...
                          height: "9rem",
                          backgroundImage:
                            "linear-gradient(90deg, rgba(232,255,90,0) 0%, rgba(232,255,90,0.62) 28%, rgba(77,172,255,0.50) 52%, rgba(232,255,90,0.42) 68%, rgba(232,255,90,0) 100%)",
        ...
        <div
          ...
          style={{
            ...
            boxShadow:
              "0 0 24px -8px rgba(232,255,90,0.14), 0 0 16px -8px rgba(77,172,255,0.10)",
          }}
        >
          <p
            className="text-fg-2"
