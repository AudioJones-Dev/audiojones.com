...
const STEPS = [
  ...
  },
  {
    ...
    glow: "0 0 40px -10px rgba(77,172,255,0.28), 0 0 16px -6px rgba(232,255,90,0.07), inset 0 0 0 1px rgba(77,172,255,0.08)",
    nodeColor: "#8FCAFF",
  ...
  },
  {
    ...
    bg: "linear-gradient(160deg, rgba(148,163,184,0.05) 0%, rgba(15,15,15,0.96) 100%)",
  ...
  },
  {
    ...
    accent: "#3DFFB0",
    border: "rgba(61,255,176,0.30)",
    bg: "linear-gradient(160deg, rgba(61,255,176,0.06) 0%, rgba(15,15,15,0.96) 100%)",
    glow: "0 0 28px -10px rgba(61,255,176,0.18), inset 0 0 0 1px rgba(61,255,176,0.04)",
    nodeColor: "#3DFFB0",
    nodeBg: "rgba(61,255,176,0.12)",
    active: false,
  },
] as const;
...
function ProcessRail() {
  ...
  return (
    ...
    >
      <defs>
        {/* Rail gradient: signal → data → steel → verified */}
        <linearGradient id="pp-rail-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="#E8FF5A" stopOpacity="0.34" />
          <stop offset="33%" stopColor="#4DACFF" stopOpacity="0.52" />
          <stop offset="66%" stopColor="#94A3B8" stopOpacity="0.28" />
          <stop offset="100%" stopColor="#3DFFB0" stopOpacity="0.36" />
        </linearGradient>
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div
          style={{
            ...
            height: "70%",
            background:
              "radial-gradient(ellipse 70% 60% at 85% 20%, rgba(61,255,176,0.06), transparent 65%)",
          }}
        />
        ...
        <div
          style={{
            ...
            height: "60%",
            background:
              "radial-gradient(ellipse 80% 50% at 50% 55%, rgba(77,172,255,0.08), transparent 70%)",
          }}
        />
        {/* Signal warmth — lower left, Diagnose anchor */}
        <div
          style={{
            position: "absolute",
            bottom: "0%",
            ...
            height: "55%",
            background:
              "radial-gradient(ellipse 60% 50% at 15% 80%, rgba(232,255,90,0.06), transparent 65%)",
          }}
        />
      </div>
        ...
        <div className="mb-14 max-w-3xl">
          ...
          <div
            ...
            style={{
              ...
              boxShadow: "0 0 6px 1px rgba(232,255,90,0.24)",
            }}
          />
                  ...
                  <div aria-hidden style={{ position: "relative", width: "8px", height: "8px" }}>
                    ...
                    <span
                      style={{
                        ...
                        borderRadius: "50%",
                        background: "#4DACFF",
                        boxShadow: "0 0 10px 2px rgba(77,172,255,0.48)",
                      }}
                    />
                  </div>
                ) : (
