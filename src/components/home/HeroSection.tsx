...
export default function HeroSection() {
  return (
    <section className="relative w-full overflow-hidden bg-gradient-to-br from-black via-[#0B0B0B] to-[#080808] py-16 sm:py-20 lg:py-24 text-white">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="rounded-full px-6 py-3 font-bold text-black shadow-[0_4px_20px_rgba(232,255,90,0.35)]
                         bg-signal-yellow
                         hover:bg-signal-soft transition"
              >
                Book a Consultation
              </a>
              <a
