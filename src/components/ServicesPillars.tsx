        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="group rounded-xl border border-zinc-200/50 bg-white/50 p-6 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:border-zinc-800/50 dark:bg-[#1E1E1E] dark:hover:border-zinc-700">
            <div className="flex h-full flex-col">
              <span className="material-symbols-outlined mb-4 text-5xl bg-gradient-to-r from-[#E8FF5A] to-[#4DACFF] bg-clip-text text-transparent">
                auto_awesome
              </span>
              ...
              <ul className="my-6 space-y-3 text-left text-sm text-zinc-700 dark:text-zinc-300">
                {["Brand Strategy", "Content Creation", "Audience Growth"].map((t) => (
                  <li key={t} className="flex items-center gap-3">
                    <span className="material-symbols-outlined text-xl bg-gradient-to-r from-[#E8FF5A] to-[#4DACFF] bg-clip-text text-transparent">
                      check_circle
                    </span>
                    {t}
                  </li>
              ...
              <button className="mt-auto h-11 w-full cursor-pointer rounded-lg bg-signal-yellow px-5 text-sm font-bold text-bg-base transition-all duration-300 hover:bg-signal-soft group-hover:scale-105">
                Build Your Brand
              </button>
            </div>
          </div>
