        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="group rounded-xl border border-zinc-200/50 bg-white/50 p-6 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:border-zinc-800/50 dark:bg-[#1E1E1E] dark:hover:border-zinc-700">
            <div className="flex h-full flex-col">
              ...
              <button className="mt-auto h-11 w-full cursor-pointer rounded-lg bg-gradient-to-r from-[#E8FF5A] to-[#F0FF85] px-5 text-sm font-bold text-white transition-all duration-300 hover:brightness-110 group-hover:scale-105">
                Build Your Brand
              </button>
            </div>
          </div>
