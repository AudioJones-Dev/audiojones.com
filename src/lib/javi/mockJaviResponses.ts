...
export function getMockJaviResponse(input: string): JaviResponse {
  ...
  switch (raw) {
    case "what-aj-builds":
      return {
        text:
          "Audio Jones builds Applied Intelligence Systems for founder-led businesses ($250K–$5M ARR). Think ResponseOS for revenue recovery, AI executive assistants like me, and operator workflows that turn signal into action — without the noise of a generic SaaS rebuild.",
        followUps: [
