// Lead persistence for the Founder Intelligence System diagnostic.
//
// Persists leads to NeonDB via the canonical SQL schema in
// db/migrations/001_applied_intelligence_leads.sql (table name retained
// from the prior brand for migration safety; the offer is now called the
// Founder Intelligence System). Firebase/Firestore is intentionally not
// used — see docs/architecture/stack-decision.md.
