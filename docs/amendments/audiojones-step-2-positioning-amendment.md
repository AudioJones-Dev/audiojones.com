...
| ----------------- | --------------------------------------- | ------ |
| `/step-2`         | `/step-2`                               | New    |
| `/founder-intelligence-system` | `/founder-intelligence-system`           | Exists |
| `/attribution`    | `/frameworks/map-attribution`           | Closest existing IP page |
| `/ai-readiness`   | `/founder-intelligence-system/diagnostic`      | Closest existing readiness funnel |
| `/work-with-me`   | `/founder-intelligence-system/diagnostic`      | Single conversion endpoint today |
...
- Internal links from `/step-2` and `/founder-intelligence-system` to the
